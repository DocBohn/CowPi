...
\begin{document}
    ...
    \section{Library Overview} \input{software}

    \section{Example Programs} \input{examples}

    \section{Input/Output Register Descriptions} \label{sec:IOregisterDescriptions} \input{atmega328p-registers}

    \section{Interrupts} \label{sec:Interrupts} \input{atmega328p-interrupts}

    \section{Timers} \label{sec:Timers} \input{atmega328p-timers}
